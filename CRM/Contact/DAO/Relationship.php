  ...
  static function &fields() {
    ...
    ',
        ...
        'case_id' => array(
          ...
          'is_permission_a_b_v' => array(
              'name' => 'is_permission_a_b_v',
              'type' => CRM_Utils_Type::T_BOOLEAN,
              'title' => ts('Contact A has Permission Over Contact B') ,
              'description' => 'is contact a has permission to view contact and
      related data for contact b ?
    ',
              'table_name' => 'civicrm_relationship',
              'entity' => 'Relationship',
          ...
          'is_permission_b_a_v' => array(
              'name' => 'is_permission_b_a_v',
              'type' => CRM_Utils_Type::T_BOOLEAN,
              'title' => ts('Contact B has Permission Over Contact A') ,
              'description' => 'is contact b has permission to view contact and
      related data for contact a ?
    ',
              'table_name' => 'civicrm_relationship',
              'entity' => 'Relationship',

...
class CRM_Contact_BAO_Relationship extends CRM_Contact_DAO_Relationship {
  ...
  public static function getdefaults() {
    return array(
      ...
      'is_permission_a_b' => 0,
      'is_permission_b_a' => 0,
      'is_permission_a_b_v' => 0,
      'is_permission_b_a_v' => 0,
      'description' => '',
      'start_date' => 'NULL',
      'case_id' => NULL,
      'end_date' => 'NULL',
  ...
  public static function makeURLClause($contactId, $status, $numRelationship, $count, $relationshipId, $direction, $params = array()) {
    ...
    if ($count) {
      ...
      $select .= ' SELECT civicrm_relationship.id as civicrm_relationship_id,
                          ...
                          civicrm_relationship.is_permission_a_b_v as is_permission_a_b_v,
                          civicrm_relationship.is_permission_b_a_v as is_permission_b_a_v,
  ...
  public static function getRelationship(
    ...
    if ($count) {
      ...
      while ($relationship->fetch()) {
        ...
        $values[$rid]['is_permission_a_b_v'] = $relationship->is_permission_a_b_v;
        $values[$rid]['is_permission_b_a_v'] = $relationship->is_permission_b_a_v;
